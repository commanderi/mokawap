<template>
    <div class="register">
        ...
        <div class="center">
            <form class="form" id="register-form">
                <label for="username" class="form-inputLabel" data-required="true">
                    ...
                    <input class="form-input" id="username" placeholder="用户名(4-11位字母和数字)" v-model="form.mobile" required type="text"/>
                </label>
                <label for="password" class="form-inputLabel" data-required="true">
                    ...
                    <svg id="password-toggle" @click="passwordToggle" class="form-inputIcon" data-active="false" viewBox="0 0 24 24" width="24" height="24">
                ...
                <label for="repeatPassword" class="form-inputLabel" data-required="true">
                    ...
                    <input class="form-input" id="repeatPassword" placeholder="确认密码" v-model="repeatPsd" required type="password"/>
                </label>
            ...
            <div class="form-btnRow">
                <label for="agreement" class="form-agreement">
                    ...
                    <span class="form-agreementSpan">我已看过并同意《<a href="javascript:void(0)" id="agreement-link">用户购彩服务协议</a>》</span>
                </label>
        ...
        <footer>
            <p>2010-2019 ©<span id="siteName">摩咖娱乐</span> 版权所有。</p>
        </footer>
    </div>
</template>
<script>
...
export default {
    ...
    methods: {
        getVerificationCode() {
            this.codeImg =
                "http://api.vs04o.cn/login/get_verification_code?" +
                new Date().getTime();
        },
        // 是否显示密码
        passwordToggle() {
