    ...
    <div class="content">
      ...
      <div class="module" v-if="titleType==1">
        <div class="typeSelectContainer___2sJku">
          ...
          <!--<div class="typeItem___RTnEd active">
            <div class="iconUser___3oMOg"></div>
            <div class="textItem___3nXOL">玩家账号</div>
          </div>-->
        </div>
        <div class="flex___16JOt typeContainer___3sFzL">
          <div class="userTypesLabel___1XNYo">开户类型</div>
          <div class="radioContainer___2-DV5">
            <div :class="['radioContainer___17rez', kaiHuTypeActive==index?'iconActive___1llOG':'']" v-for="(item, index) in xiaJiKaiHuType" @click="openTypeFn(index)">
                ...
                <div class="am-list-line">
                  ...
                  <div class="am-input-control">
                    <mu-select v-model="base" full-width @change="backRebatesSelect">
                      <mu-option v-for="(city,index) in backRebatesList"
                                 :key="index"
                                 :label="city.base+'-'+city.percent+'(赔率)'"
                                 :value="city.base"
                      ></mu-option>
                    </mu-select>
                  </div>
              ...
              <div class="am-list-item am-input-item am-list-item-middle">
                <div class="am-list-line">
                  ...
                  <div class="am-input-extra">
                    <div class="createCode___5Ds8c" @click="getProduceCode">
                      点击选码
                    </div>
                  </div>
                </div>
      ...
      <div class="module" v-if="titleType==2">
        <div class="flex___16JOt container___XQ04F">
          ...
          <div class="listBody___3sgl1">
            <div class="listItem___mD7l4" v-for="(item, index) in promotionList">
          ...
          <table class="editContainer-table">
              ...
              <td>
                <div class="flex___16JOt ">
                  <div class="radioContainer___3GUNp">
                    ...
                    <!--<div class="radioContainer___17rez ">
                      <div class="iconRadio___1-_b1 iconActive___1llOG"></div>
                      玩家
                    </div>-->
                  </div>
                </div>
            ...
            <tr>
              ...
              <td>
                <div class="flex___16JOt ">
                  <div class="radioContainer___3GUNp">
                    <div :class="['radioContainer___17rez', editForm.status==index?'iconActive___1llOG':''] " v-for="(item, index) in statusType" @click="statusTypeFn(index)">
                      <div class="iconRadio___1-_b1"></div>
                      {{item.name}}
                    </div>
                  </div>
...
<script>
  ...
  import { GetBackRebates, ProduceCode, MewMember, AddProduceCode, GetPromotionLinks, EditProduceCode } from '../../axios/api.js'
  export default {
    name: 'add-agent',
    data() {
      return {
