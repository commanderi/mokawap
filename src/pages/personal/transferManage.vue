      ...
      <div class="container___2Zckg">
        ...
        <div class="flex___16JOt moneyItem___3oXcd">
          ...
          <div class="rightOption___34ejk">
            <div class="button3___3mPn4" @click="yiJianZhuanRuFn('AG')">
              一键转入
            </div>
            <div class="button4___1bFnx" @click="getGameMoney('AG')">
              刷 新
            </div>
          </div>
        </div>
        <div class="flex___16JOt moneyItem___3oXcd">
          ...
          <div class="rightOption___34ejk">
            <div class="button3___3mPn4" @click="yiJianZhuanRuFn('IBC')">
              一键转入
            </div>
            <div class="button4___1bFnx" @click="getGameMoney('IBC')">
              刷 新
            </div>
          </div>
        </div>
        <div class="flex___16JOt moneyItem___3oXcd">
          ...
          <div class="rightOption___34ejk">
            <div class="button3___3mPn4" @click="yiJianZhuanRuFn('KY')">
              一键转入
            </div>
            <div class="button4___1bFnx" @click="getGameMoney('KY')">
              刷 新
            </div>
          </div>
        </div>
        <div class="flex___16JOt moneyItem___3oXcd">
          ...
          <div class="rightOption___34ejk">
            <div class="button3___3mPn4" @click="yiJianZhuanRuFn('CQ')">
              一键转入
            </div>
            <div class="button4___1bFnx" @click="getGameMoney('CQ')">
              刷 新
            </div>
          </div>
        </div>
        <div class="flex___16JOt moneyItem___3oXcd">
          ...
          <div class="rightOption___34ejk">
            <div class="button3___3mPn4" @click="yiJianZhuanRuFn('JDB')">
              一键转入
            </div>
            <div class="button4___1bFnx" @click="getGameMoney('JDB')">
              刷 新
            </div>
          </div>
        </div>
            ...
            <div class="am-flexbox-item">
              <div class="am-list-item">
                <mu-select v-model="typeLeft" full-width @change="selectLeft">
                  <mu-option v-for="(city,index) in selectListLeft"
                             :key="index"
                             :label="city.name"
                             :value="city.game"
                  ></mu-option>
            ...
            <div class="am-flexbox-item" style="margin-left: 0;">
              <div class="am-list-item" style="padding-left: 0;">
                <mu-select v-model="typeRight" full-width @change="selectRight">
                  <mu-option v-for="(city,index) in selectListRight"
                             :key="index"
                             :label="city.name"
                             :value="city.game"
                  ></mu-option>
