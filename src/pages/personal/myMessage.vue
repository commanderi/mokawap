                ...
                <div class="am-popover-inner" v-if="isSelect">
                    <div class="body___1t9uH">
                        <div class="menuBody___2PhYY">
                            <div :class="['menuItem___2Mzkn', item.active?'active':'']" v-for="(item, index) in typeList" :key="index" @click="confirmPlaying(index)">{{item.name}}</div>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <template>
                            <div class="container___2jMj3" v-for="(item, index) in dataList" :key="index">
                                ...
                                <div class="textContent___TkhLO">
                                    <div class="texts___3Tbos">{{item.content}}</div>
                                </div>
                            </div>
                        </template>
                    </mu-list>
...
.container___2jMj3 {
    ...
    .title___3SxHD {
        font-size: 0.32rem;
        margin: 0.26rem 0 0.1rem 0.36rem;
    }
    .time___3qKP_ {
        color: #999;
        margin-left: 0.38rem;
