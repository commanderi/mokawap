        ...
        <div class="am-list-body">
          <div class="am-list-item am-input-item am-list-item-middle">
            <div class="am-list-line">
              ...
              <div class="am-input-control"><input maxlength="30" v-model="form.true_name" placeholder="请输入持卡人姓名" type="text" value=""></div>
              <!--<div class="am-input-extra">
                <div class="iconTip___3P5-C"></div>
              </div>-->
            </div>
          </div>
          <div class="am-list-item am-input-item am-list-item-middle">
            <div class="am-list-line">
              ...
              <div class="am-input-control"><input v-model="form.bank_card" placeholder="请输入银行卡号" maxlength="23" type="tel" value=""></div>
            </div>
          </div>
          <div class="am-list-item selectItem___4UUg- am-list-item-middle">
            <div class="am-list-line">
              <div class="am-list-content">银行名称</div>
              <div class="am-input-control"><input v-model="form.bank" placeholder="请输入开户银行" maxlength="23" type="text" value=""></div>
              <!--<div class="am-list-extra">
                <div>
                  <div class="">
                    <div>
                      <div class="placeholder___25PT3">请选择开户银行</div>
                    </div>
                  </div>
                </div>
              </div>-->
          ...
          <div class="am-list-item am-input-item am-list-item-middle">
            <div class="am-list-line">
              ...
              <div class="am-input-control"><input v-model="form.branch_bank" placeholder="请输入省市区（县）" type="text" value=""></div>
            </div>
          </div>
          <div class="am-list-item am-input-item am-list-item-middle" v-if="dataInfo.money_password==0">
            <div class="am-list-line">
              ...
              <div class="am-input-control"><input v-model="form.money_password" placeholder="请设置提现密码" maxlength="4" type="password" value=""></div>
              <!--<div class="am-input-extra">
                <div class="iconTip___3P5-C"></div>
              </div>-->
            </div>
