            ...
            <div class="am-list">
                <div class="am-list-body">
                    <div class="am-list-item am-input-item am-list-item-middle">
                        <div class="am-list-line">
                            <div class="am-input-control">
                                <input v-model="form.old_password" maxlength="4" placeholder="请输入旧密码" type="password" value/>
                            </div>
                        </div>
                    </div>
                    <div class="am-list-item am-input-item am-list-item-middle">
                        <div class="am-list-line">
                            <div class="am-input-control">
                                <input v-model="form.new_password1" maxlength="4" placeholder="请输入新密码（4位）" type="password" value/>
                            </div>
                        </div>
                    </div>
                    <div class="am-list-item am-input-item am-list-item-middle am-input-focus am-input-android">
                        <div class="am-list-line">
                            <div class="am-input-control">
                                <input v-model="form.new_password2" maxlength="4" placeholder="确定密码" type="password" value/>
                            </div>
                        </div>
                    </div>
                </div>
