    ...
    <div class="recharge-list">
        ...
        <div class="content">
            <div class="tabs___GR8qK" v-if="type==3">
                <div :class="['tabItem___15C8_', item.active?'active___1RQIG':'']" v-for="(item, index) in typeList" :key="index" @click="getTypeZH(index)">{{item.name}}</div>
            </div>
                                ...
                                <div class="flex___16JOt list-box" v-for="(item, index) in dataList" :key="index">
                                    ...
                                    <div class="col3">
                                        ...
                                        <div v-if="type==2" style="width: 100%;">
                                            ...
                                            <span v-if="item.status==3">失败</span>
                                        </div>
                                    </div>
